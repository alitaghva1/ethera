...
function drawSlimeHUD() {
    ...
    // Talisman indicator — uses the real talisman_drop sprite with screen blend
    // (black bg becomes transparent). Falls back to a procedural diamond if the
    // image isn't loaded yet. Positioned below relic row + HOSTILE indicator.
    if (FormSystem.talisman.found) {
