...
const PORTAL_POS   = { x: 688, y: 368 };   // dark circular pit — flood-fill from the darkest pixel (lum=22) shows the pit blob is at world bbox x[652-724] y[336-402], center (688, 368). Earlier guesses missed because they only sampled small regions and luminance-thresholded centroids drift
